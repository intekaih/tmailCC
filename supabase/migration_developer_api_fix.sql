-- ============================================================
-- TMail - Developer API Tables Migration
-- ============================================================
-- Run this script in Supabase Dashboard > SQL Editor
-- This ensures api_keys, webhooks, and related tables exist
-- ============================================================
...
drop policy if exists api_usage_logs_own_select on public.api_usage_logs;
...
drop policy if exists webhooks_own_select on public.webhooks;
...
drop policy if exists webhooks_own_insert on public.webhooks;
...
drop policy if exists webhooks_own_update on public.webhooks;
...
drop policy if exists webhooks_own_delete on public.webhooks;
...
drop policy if exists webhook_deliveries_own_select on public.webhook_deliveries;
...
-- This is the key to fixing the PGRST205 error!
-- ============================================================

-- Notify PostgREST to reload the schema cache
-- This is required after creating new tables for the API to see them
notify pgrst, 'reload schema';

-- Also try the admin extension if available
-- This helps refresh the schema cache in Supabase
create extension if not exists pgrest_advisory_lock;
